...
main() {
  ...
  INSTALL_IPADAPTER_FACEID="$INSTALL_IPADAPTER_FACEID" \
  INSTALL_EXPRESSION_LORAS="$INSTALL_EXPRESSION_LORAS" \
  INSTALL_NSFW_LORAS="$INSTALL_NSFW_LORAS" \
  EXPRESSION_LORA_REPO="$EXPRESSION_LORA_REPO" \
  EXPRESSION_LORA_FILES="$EXPRESSION_LORA_FILES" \
  NSFW_LORA_REPO="$NSFW_LORA_REPO" \
  NSFW_LORA_FILES="$NSFW_LORA_FILES" \
  "$BOOTSTRAP_SCRIPT"
